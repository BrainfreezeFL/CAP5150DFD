...
class DNNAttack:
    ...
    def build(input_shape, classes):
        ...
        model.add(tf.keras.layers.MaxPooling1D(pool_size=pool_size[1], strides=pool_stride_size[1],
                               padding='same', name='block1_pool'))
        model.add(tf.keras.layers.Dropout(0.1, name='block1_Dropout'))
        model.add(tf.keras.layers.Dense(512, kernel_initializer=tf.keras.initializers.glorot_uniform(seed=0), name='fc3'))
        model.add(tf.keras.layers.BatchNormalization())
        model.add(tf.keras.layers.Activation('relu', name='fc3_act'))
        model.add(tf.keras.layers.Dense(512, kernel_initializer=tf.keras.initializers.glorot_uniform(seed=0), name='fc4'))
        model.add(tf.keras.layers.BatchNormalization())
        ...
        model.add(tf.keras.layers.Dense(512, kernel_initializer=tf.keras.initializers.glorot_uniform(seed=0), name='fc5'))
        model.add(tf.keras.layers.BatchNormalization())
        model.add(tf.keras.layers.Activation('relu', name='fc5_act'))
        model.add(tf.keras.layers.Dropout(0.1, name='block3_Dropout'))
        model.add(tf.keras.layers.Dense(classes, kernel_initializer=tf.keras.initializers.glorot_uniform(seed=0), name='fc6'))
        model.add(tf.keras.layers.BatchNormalization())
